...
import { Upload, Box, Search, ArrowUpRight, ArrowDownLeft, ChevronLeft, ChevronRight, BarChart as ChartIcon, Info, Wallet, Users } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-8">
              <div className="text-2xl font-semibold text-[var(--color-text-dark)]">
      ...
      <main className="container mx-auto px-6 pt-28 pb-12 space-y-12">
        ...
        <section className="space-y-4">
          ...
          >
            <div className="flex justify-between items-start">
              <div>
                <p className="text-[var(--color-text-tertiary)] mb-2">DIDs</p>
                <p className="text-2xl font-semibold text-[var(--color-text-primary)]">
          ...
          <div className="bg-[var(--color-bg-tertiary)] p-6 rounded-lg shadow-sm relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-[var(--color-text-tertiary)] mb-2">Max Supply</p>
                <p className="text-2xl font-semibold text-[var(--color-text-primary)]">
                  <AnimatedCounter value={51400000} />
                </p>
              </div>
              <div className="bg-[var(--color-bg-success)] p-2 rounded-lg">
          ...
          <div className="bg-[var(--color-bg-tertiary)] p-6 rounded-lg shadow-sm relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-[var(--color-text-tertiary)] mb-2">Circulating Supply</p>
                <p className="text-2xl font-semibold text-[var(--color-text-primary)]">
                  <AnimatedCounter value={3852056} />
                </p>
              </div>
              <div className="bg-[var(--color-bg-success)] p-2 rounded-lg">
          ...
          <div className="bg-[var(--color-bg-tertiary)] p-6 rounded-lg shadow-sm relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-[var(--color-text-tertiary)] mb-2">Total Value Locked (TVL)</p>
                <p className="text-2xl font-semibold text-[var(--color-text-primary)]">
                  <AnimatedCounter value={226.261} formatFn={(v) => `${v.toLocaleString()} $Mn`} />
                </p>
              </div>
              <div className="bg-[var(--color-bg-success)] p-2 rounded-lg">
          ...
          <div className="bg-[var(--color-bg-tertiary)] p-6 rounded-lg shadow-sm relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-[var(--color-text-tertiary)] mb-2">Number Of Smart Contracts</p>
                <p className="text-2xl font-semibold text-[var(--color-text-primary)]">
                  <AnimatedCounter value={141} />
                </p>
              </div>
              <div className="bg-[var(--color-bg-success)] p-2 rounded-lg">
                <Box className="w-5 h-5 text-white" />
              ...
              <table className="w-full">
                <thead className="bg-[var(--color-bg-secondary)]">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-sm font-semibold text-[var(--color-text-tertiary)]">Date & Time</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-[var(--color-text-tertiary)]">Amount (RBT)</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-[var(--color-text-tertiary)]">Type</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-[var(--color-text-tertiary)]">Subnet ID</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  {currentTransactions.map((tx) => (
                    <tr key={tx.id} className="hover:bg-[var(--color-bg-secondary)]">
                      ...
                      <td className="px-4 py-3 text-sm text-[var(--color-text-primary)]">{tx.subnetId}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
