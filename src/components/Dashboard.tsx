          ...
          <div className="absolute right-0 top-0 h-full w-full max-w-2xl bg-white shadow-xl">
            ...
            <div className="p-6">
              <div className="space-y-6">
                <div>
                  <h4 className="text-sm text-[var(--color-text-tertiary)] mb-1">Transaction ID</h4>
                  <p className="text-[var(--color-text-primary)] font-medium">{selectedTransaction.txId}</p>
                </div>
                <div>
                  <h4 className="text-sm text-[var(--color-text-tertiary)] mb-1">Sender ID</h4>
                  <p className="text-[var(--color-text-primary)] font-medium">{selectedTransaction.senderId}</p>
                </div>
                <div>
                  <h4 className="text-sm text-[var(--color-text-tertiary)] mb-1">Receiver ID</h4>
                  <p className="text-[var(--color-text-primary)] font-medium">{selectedTransaction.receiverId}</p>
                </div>
                <div>
                  <h4 className="text-sm text-[var(--color-text-tertiary)] mb-1">Amount</h4>
                  <p className="text-[var(--color-text-primary)] font-medium">{selectedTransaction.amount}</p>
                </div>
                <div>
                  <h4 className="text-sm text-[var(--color-text-tertiary)] mb-1">Timestamp</h4>
                  <p className="text-[var(--color-text-primary)] font-medium">
                    {selectedTransaction.timestamp.toLocaleString()}
                  </p>
                </div>
                <div>
                  <h4 className="text-sm text-[var(--color-text-tertiary)] mb-1">Subnet ID</h4>
                  <p className="text-[var(--color-text-primary)] font-medium">{selectedTransaction.subnetId}</p>
                </div>
              </div>
            </div>
          </div>
